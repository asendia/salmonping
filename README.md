...
gcloud scheduler jobs create http salmonping_ping --schedule="1,11,21,31,41,51 9-20 * * 1-6" --location="asia-southeast2" --time-zone="Asia/Jakarta" --uri=ENDPOINT_URL --http-method=GET --headers="X-API-Key=API_KEY"
